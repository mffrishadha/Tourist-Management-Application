...
<body>
	...
	<div class="limiter" align="center">
				<form method="post" class="login100-form validate-form align-top" action="/create-customer">
					<span class="login100-form-title p-b-34">USER REGISTRATION</span>
					
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type user name">
						<input id="first-name" class="input100" type="text" name="firstname" placeholder="First name">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 rs2-wrap-input100 validate-input m-b-20" data-validate="Type user name">
					...
					<div class="form-group wrap-input100 validate-input m-b-20">
