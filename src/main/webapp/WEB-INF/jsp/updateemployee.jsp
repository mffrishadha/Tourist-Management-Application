...
<body>
	  ...
	  <div class="limiter" align="center">
                  <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
                               <form:form method="post" action="/update-employee/${id}" class="login100-form validate-form align-top">
                 					<span class="login100-form-title p-b-34"> UPDATE USER PROFILE </span>
                 					...
                 					<div class="wrap-input100 rs2-wrap-input100 validate-input m-b-20" data-validate="Type Last name">
                 						<form:input path="lastname" class="input100" type="text"/>
                 						<span class="focus-input100"></span>
                 					</div>
                 					...
                 					<div class="wrap-input100 validate-input m-b-20"data-validate="Type phone number" >
                 						<form:input path="phoneNo" class="input100" type="text"/>
                 						<span class="focus-input100"></span>
                 					</div>
                 					...
                 					<div class="wrap-input100 validate-input m-b-20">
                 						<form:input path="nic" class="input100" type="text"/>
                 						<span class="focus-input100"></span>
                 					</div>
                 					<div class="wrap-input100 validate-input m-b-20">
                 					...
                 					<div class="wrap-input100 validate-input m-b-20">
                                         <form:input path="userType" class="input100" type="text"/>
                                         <span class="focus-input100"></span>
                                    </div>
